	...
	class AutomaticReviewMappingHelper
    	...
    	def check_if_all_artifacts_num_are_zero(flash,params)
    		...
    		if @calibrated_artifacts_num == 0 and @uncalibrated_artifacts_num == 0
    			assign_reviews_for_artifacts_num_zero(flash,obj,params)
    		else
    			assign_reviews_for_artifacts_num_not_zero(obj,params,flash)
    		end

    	end

    	def assign_reviews_for_artifacts_num_zero(flash,obj,params)
    		...
    		if @student_review_num == 0 and @submission_review_num == 0
        		...
        		# REVIEW: mapping strategy
             	automatic_review_mapping_strategy(@assignment_id, @participants, @teams, @student_review_num, @submission_review_num,obj,flash,params)
      		else
    	...
    	def assign_reviews_for_artifacts_num_not_zero(obj,params,flash)
        	...
        	@teams_with_calibrated_artifacts << AssignmentTeam.find(response_map.reviewee_id)
      		...
      		# REVIEW: mapping strategy
      		automatic_review_mapping_strategy(@assignment_id, @participants, @teams_with_calibrated_artifacts.shuffle!, @calibrated_artifacts_num, 0,obj,flash,params)
      		
      		# REVIEW: mapping strategy
      		# since after first mapping, participants (delete_at) will be nil
      		@participants = AssignmentParticipant.where(parent_id: params[:id].to_i).to_a.reject {|p| p.can_review == false }.shuffle!
      		automatic_review_mapping_strategy(@assignment_id, @participants, @teams_with_uncalibrated_artifacts.shuffle!, @uncalibrated_artifacts_num, 0,obj,flash,params)
    	...
    	def automatic_review_mapping_strategy(assignment_id,
                                        ...
                                        submission_review_num = 0,obj,flash,params)
    		participants_hash = {}
    		...
    		execute_peer_review_strategy(assignment_id, teams, num_participants,
                                 ...
                                 participants, participants_hash,flash,params)
    		...
    		assign_reviewers_for_team(assignment_id, student_review_num, participants_hash,
                              exact_num_of_review_needed,flash,params)
  		end
  		...
  		def peer_review_strategy(assignment_id, teams, num_participants, student_review_num, num_reviews_per_team, participants, participants_hash,flash,params)
    	iterator = 0
    	teams.each do |team|
